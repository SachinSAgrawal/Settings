...
extension SettingsViewController {
    ...
    func settingsConfiguration() {
        ...
        models.append(Section(title: "Search", options: [
            .staticCell(model: SettingsOption(title: "John Appleseed", icon: UIImage(systemName: "person.fill"), iconBackgroundColor: .systemCyan, accessory: .none, detailText: nil, handler: {
                self.showAlert(title: "John Appleseed", message: "Apple Account, iCloud+, and more")
            }, submenuSections: nil, staticText: nil, isLarge: true))
        ], footer: "Apple Account, iCloud+, and more"))
        ...
        models.append(Section(title: "", options: [
            ...
            .staticCell(model: SettingsOption(title: "Apple Intelligence & Siri", icon: UIImage(systemName: "apple.intelligence"), iconBackgroundColor: .systemYellow, accessory: .disclosureIndicator, detailText: nil, handler: {
                self.showAlert(title: "Apple Intelligence & Siri", message: "Placeholder")
            }, submenuSections: nil, staticText: nil, isLarge: false)),
            ...
            .staticCell(model: SettingsOption(title: "Display and Brightness", icon: UIImage(systemName: "sun.max.fill"), iconBackgroundColor: .systemBlue, accessory: .disclosureIndicator, detailText: nil, handler: {
                self.showAlert(title: "Display and Brightness", message: "Placeholder")
            }, submenuSections: nil, staticText: nil, isLarge: false)),
        ...
        models.append(Section(title: "", options: [
            ...
            .staticCell(model: SettingsOption(title: "iCloud", icon: UIImage(named: "icloud"), iconBackgroundColor: .secondarySystemBackground, accessory: .disclosureIndicator, detailText: nil, handler: {
    ...
    func reloadWifiCell() {
        models[2].options[1] = .staticCell(model: SettingsOption(title: "Wi-Fi", icon: UIImage(systemName: "wifi"), iconBackgroundColor: .systemBlue, accessory: .disclosureIndicator, detailText: UserDefaults.standard.string(forKey: "wifi"), handler: {
            self.saveWiFi(title: "Wi-Fi", message: "Enter network name:", placeholder: "127.0.0.1")
        }, submenuSections: nil, staticText: nil, isLarge: false))
